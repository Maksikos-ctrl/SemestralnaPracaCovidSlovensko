...
while 1
    ...
    switch in
        ...
        case 2 
           ...
           [start_date,end_date] = getData(input("Zadajte d�tum �od�: "), ...
                input("Zadajte d�tum �do�: "), date);
            if (isstring(start_date) || isstring(end_date))
                disp("Nespr�vny d�tum!")
            else
                val = val(start_date:end_date);
        ...
        case 3 
            ...
            if (isstring(start_date) || isstring(end_date))
                ...
                yline(median_val, '--');
                yline(given_poz, '--');
                input("Vyssie uveden� poz�cia -" + above_given_poz + " dni\n" + ...
